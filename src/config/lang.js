...
const lang = {
    en: {
        ...
        minText: "🚫 The minimum withdrawal amount is 40,000 CFA francs.",
        min(amount) {
...
♻️ You earn 5,500 FCFA for each person invited
...
♻️ Tu gagne 5,500 FCFA pour chaque personne invité 
